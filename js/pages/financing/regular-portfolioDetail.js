/*
* @Author: User
* @Date:   2016-06-13 18:33:00
* @Last Modified by:   User
* @Last Modified time: 2016-10-21 17:19:53
*/

$(function(){
    
var $tabcon       = $('.regular-portfolioDetailList');
...
var setListData3 = doT.template([
    ...
    '<div class="item">',
      ...
      '<i class="money"><span>资产金额</span>{{=item.loanAmount}}元</i>',
      '</div>',
      '</div>',
      '</dl>',
    '{{~}}'
...
var setListData2 = doT.template([
    '<dl >',
  //'<div class="caption">'+temp+'<a href="../../pages/financing/regular-portfolio.html" class="back"></a>',
  //'<div class="caption">'+temp+'<a href="../../pages/financing/regularDetail.html?cycle='+cycle+'" class="back"></a>',
  //'</div>',
     '</dl>'
  ].join(''));
