    ...
    showTooltips: function (loc, ctx) {
        ...
        if (dis <= this.circle.radius) {
            ...
            if (this.tooltips.tooltipCanvas == null) {
                ...
                this.tooltips.tooltipCanvas.height = 150;
            }
            ...
            m_context.roundRect(2, 2, this.tooltips.tooltipCanvas.width - 40, this.tooltips.tooltipCanvas.height - 40, 5, true, true);
...
//            var linePos = (hx < this.circle.cx) ? (hx - this.edge.width) : (hx + this.edge.width);  
            var linePos = (hx < this.circle.cx) ? hx - 100 : hx + 100;
...
//            var textPos = (hx < this.circle.cx) ? (hx - this.edge.width*2) : (hx + this.edge.width);  
            var textPos = (hx < this.circle.cx) ? hx - 100 : hx - 10;
            ...
            ctx.fillStyle = "black";
            ctx.fillText(tipStr, textPos, hy - 10);
        }
    },
