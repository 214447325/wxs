...
$(function(){
    ...
    var $returnImg = $('.returnImg');//返回上一页按钮
            ...
            Common.ajaxDataFilter(res,function(){
                ...
                var _sort = res.data.sort(function(a,b){
                 ...
                 if (res.data.length == 0) {
                      $table_box.html("<img src='../../../images/pages/my-account3.0/null3.0.png'><p class='Null'>暂无数据</p>");
                 }else{
...
//           	$(".contentBody").html("menu:" + currentid + ",item:" + textvalue + ",对应链接");
        ...
        $('.navList').find("li").on('click', function () {
            ...
            $(".navList").find("ul[namevalue='"+currentid+"'] li.current").removeClass('current');
