...
/*
 * @Author: User
 * @Date:   2016-06-14 17:55:59
 * @Last Modified by:   User
 * @Last Modified time: 2016-06-21 18:03:51
 */
...
//  }
    ...
    var setListData2 = doT.template([
        '<dl >',
        '<div class="caption">'+temp+'<a href="../../../pages/my-account/regular/regularPortfolio3.0.html?hadShare='+hasmoney + '" class="back"></a>',
        '</div>',
        '</dl>'
    ].join(''));
