...
var setListData2 = doT.template([
    '<dl >',
  '<div class="caption">'+temp+'<a href="../../pages/my-account/floatPortfolio.html?type=4&lineId='+param.lineId+'&floatHasmoney='+floatHasmoney+'" class="back"></a>',
  '</div>',
     '</dl>'
  ].join(''));
