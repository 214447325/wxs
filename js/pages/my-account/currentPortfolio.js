/*
* @Author: User
* @Date:   2016-06-14 11:23:57
* @Last Modified by:   User
* @Last Modified time: 2016-06-21 19:07:34
*/
...
//  }
  ...
  var setListData = doT.template([
    ...
    '<div class="item">',
	    '<a class="title" href="currentPortfolioDetails.html?hadShare='+hadShare+'&type=1&code={{=item.purposeCode}}">{{=item.loanPurpose}}',
			'<i  >({{=item.count}}个)</i>',    
